...
(function KeyboardShortcut() {
	...
	function focusOnApp() {
		return document.querySelector(
			".Root__main-view .os-viewport, .Root__main-view .main-view-container__scroll-node:not(:has([data-overlayscrollbars-viewport])), .Root__main-view .main-view-container__scroll-node > [data-overlayscrollbars-viewport]"
		);
	}

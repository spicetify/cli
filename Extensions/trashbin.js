...
(function TrashBin() {
  ...
  function settingsContent() {
    ...
    content.appendChild(
      createButton(
        "Export",
        "Copy json containing all items in trashbin to clipboard.",
        exportTracks
      )
    );
    content.appendChild(
      createButton(
        "Import",
        "Add batches of songs to trashbin via json file.",
        importTracks
      )
    );
    content.appendChild(
  ...
  const trashbinStatus =
    JSON.parse(Spicetify.LocalStorage.get("trashbin-enabled")) ?? true;

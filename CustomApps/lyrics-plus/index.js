...
const CONFIG = {
	...
	providers: {
		...
		genius: {
			...
			desc: "Provide unsynced lyrics with insights from artists themselves. Genius is disabled on <code>1.2.31</code> and higher and cannot be used as an provider.",
			modes: [GENIUS]
		},
		local: {

(async function PlaybarButton() {
	...
	const page = Spicetify.Platform.History.location.pathname;
	const active = localStorage.getItem("lyrics-plus:visual:playbar-button");
	if (page !== "/lyrics-plus" && active === "true") {
		setPlaybarButton();
	}
})();

...
Spicetify.SVGIcons = {
	...
	album:
		"<path d='M8 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z'/><path d='M8 6.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3zM5 8a3 3 0 1 1 6 0 3 3 0 0 1-6 0z'/>",
	artist:
	...
	block: "<path d='M8 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z'/><path d='M12 8.75H4v-1.5h8v1.5z'/>",
	brightness:
	...
	car: "<path d='M2.92 2.375A2.75 2.75 0 0 1 5.303 1h5.395c.983 0 1.89.524 2.382 1.375L14.017 4h1.233a.75.75 0 0 1 0 1.5h-.237c.989.9.988 2.117.987 2.707v7.043a.75.75 0 0 1-.75.75h-1.5a.75.75 0 0 1-.75-.75V14H3v1.25a.75.75 0 0 1-.75.75H.75a.75.75 0 0 1-.75-.75V8.207C0 7.617-.002 6.4.987 5.5H.75a.75.75 0 0 1 0-1.5h1.233l.938-1.625zm2.382.125c-.446 0-.859.238-1.082.625L3.137 5h9.726L11.78 3.125a1.25 1.25 0 0 0-1.083-.625H5.302zm8.57 4H2.128a2.72 2.72 0 0 1-.055.046c-.473.377-.556.894-.57 1.454h2.429a1 1 0 0 1 1 1v.5H1.5v3h13v-3h-3.43V9a1 1 0 0 1 1-1h2.427c-.013-.56-.096-1.077-.569-1.454a2.585 2.585 0 0 1-.055-.046z'/>",
	"chart-down": "<path d='m14 6-6 6-6-6h12z'/>",
	"chart-up": "<path d='M14 10 8 4l-6 6h12z'/>",
	...
	"chevron-left": "<path d='M11.03.47a.75.75 0 0 1 0 1.06L4.56 8l6.47 6.47a.75.75 0 1 1-1.06 1.06L2.44 8 9.97.47a.75.75 0 0 1 1.06 0z'/>",
	"chevron-right": "<path d='M4.97.47a.75.75 0 0 0 0 1.06L11.44 8l-6.47 6.47a.75.75 0 1 0 1.06 1.06L13.56 8 6.03.47a.75.75 0 0 0-1.06 0z'/>",
	"chromecast-disconnected":
		"<path d='M.667 12v2h2c0-.55-.196-1.021-.588-1.413A1.925 1.925 0 0 0 .667 12zm0-2.667v1.334c.92 0 1.706.325 2.357.976.65.65.976 1.436.976 2.357h1.333c0-.635-.123-1.24-.369-1.817a4.666 4.666 0 0 0-.992-1.489 4.67 4.67 0 0 0-1.488-.992 4.583 4.583 0 0 0-1.817-.369zm0-2.666V8c1.085 0 2.087.269 3.008.806a5.978 5.978 0 0 1 2.186 2.186c.537.92.806 1.923.806 3.008H8a7.35 7.35 0 0 0-.369-2.317 6.956 6.956 0 0 0-1.048-2.02A7.918 7.918 0 0 0 5 8.083a7.01 7.01 0 0 0-2.024-1.047 7.31 7.31 0 0 0-2.31-.37l.001.001zM14 2H2a1.28 1.28 0 0 0-.94.393 1.283 1.283 0 0 0-.393.94v2H2v-2h12v9.334H9.333V14H14c.365 0 .679-.131.94-.393.262-.262.393-.575.393-.94V3.333c0-.365-.131-.678-.393-.94A1.28 1.28 0 0 0 14 2z'/>",
	clock:
		"<path d='M8 1.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13zM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8z'/><path d='M8 3.25a.75.75 0 0 1 .75.75v3.25H11a.75.75 0 0 1 0 1.5H7.25V4A.75.75 0 0 1 8 3.25z'/>",
	computer:
		"<path d='M0 2.75C0 1.784.784 1 1.75 1h12.5c.966 0 1.75.784 1.75 1.75v7.5A1.75 1.75 0 0 1 14.25 12H1.75A1.75 1.75 0 0 1 0 10.25v-7.5zm1.75-.25a.25.25 0 0 0-.25.25v7.5c0 .138.112.25.25.25h12.5a.25.25 0 0 0 .25-.25v-7.5a.25.25 0 0 0-.25-.25H1.75zm2.5 12.75A.75.75 0 0 1 5 14.5h6a.75.75 0 0 1 0 1.5H5a.75.75 0 0 1-.75-.75z'/>",
	copy: "<path d='m8.235 3.569 1.11-1.11a3.012 3.012 0 1 1 4.261 4.26L11.464 8.86a3.012 3.012 0 0 1-4.907-.96 1.49 1.49 0 0 0-.952.436l-.351.351a4.524 4.524 0 0 0 7.279 1.242l2.142-2.143A4.524 4.524 0 1 0 8.277 1.39L6.292 3.373a6.063 6.063 0 0 1 1.943.195z'/><path d='m7.765 12.56-1.11 1.11a3.013 3.013 0 0 1-4.261-4.26l2.142-2.142a3.012 3.012 0 0 1 4.907.96 1.49 1.49 0 0 0 .952-.436l.351-.351a4.524 4.524 0 0 0-7.279-1.242L1.325 8.342a4.524 4.524 0 1 0 6.398 6.397l1.985-1.984a6.064 6.064 0 0 1-1.943-.195z'/>",
	download:
		"<path d='M4.995 8.745a.75.75 0 0 1 1.06 0L7.25 9.939V4a.75.75 0 0 1 1.5 0v5.94l1.195-1.195a.75.75 0 1 1 1.06 1.06L8 12.811l-.528-.528a.945.945 0 0 1-.005-.005L4.995 9.805a.75.75 0 0 1 0-1.06z'/><path d='M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-6.5a6.5 6.5 0 1 0 0 13 6.5 6.5 0 0 0 0-13z'/>",
	downloaded:
